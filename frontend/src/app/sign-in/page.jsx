...
export const metadata = {
  title: 'Đăng nhập - IELTS Listening Platform',
  description: 'Đăng nhập để tiếp tục học IELTS Listening',
};
        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-primary-50 text-gray-500">Hoặc đăng nhập với</span>
            </div>
          </div>
