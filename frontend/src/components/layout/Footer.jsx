          ...
          <div>
            ...
            <ul className="space-y-2">
              {footerLinks.product.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-gray-400 dark:text-gray-500 hover:text-white dark:hover:text-gray-300 transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
        ...
        <div className="pt-8 border-t border-gray-800 dark:border-gray-900">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-sm text-gray-400 dark:text-gray-500">
              <Link href="/terms" className="hover:text-white dark:hover:text-gray-300 transition-colors">
                {t('footer.terms')}
              </Link>
              <Link href="/privacy" className="hover:text-white dark:hover:text-gray-300 transition-colors">
                {t('footer.privacy')}
              </Link>
              <Link href="/cookies" className="hover:text-white dark:hover:text-gray-300 transition-colors">
                {t('footer.cookies')}
              </Link>
            </div>
          </div>
