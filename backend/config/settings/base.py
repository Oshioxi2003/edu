"""
Base settings for education platform.
"""
import os
...
from config.celery_config import CELERY_BEAT_SCHEDULE
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@edu.vn')
...
MOMO_RETURN_URL = os.environ.get('MOMO_RETURN_URL', 'http://localhost:3000/payment/return')
MOMO_NOTIFY_URL = os.environ.get('MOMO_NOTIFY_URL', 'http://localhost:8000/api/payments/momo/ipn')

# Signed URL expiration (seconds)
SIGNED_URL_EXPIRATION = 300  # 5 minutes
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API for educational listening platform',
    'VERSION': '1.0.0',
